...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark"
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white active bg-gradient-primary" href="/admin/join">
...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <!-- Modal -->
    <div class="modal fade" data-bs-backdrop="static" id="emailAuthNumber" aria-hidden="true"
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-floating">
                            <input id="auth_number" type="text" class="form-control" placeholder="인증번호 8자리를 입력해주세요!"
                                   maxlength="8">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">회원가입</li>
                </ol>
            </nav>
                            ...
                            <form class="text-start">
                                ...
                                <div class="input-group-addon">
                                    <button type="button" id="mail-Check-Btn" class="btn btn-primary" href="#!"
                                            data-bs-toggle="modal" data-bs-target="#emailAuthNumber" disabled>이메일인증하기
                                    </button>
                                </div>
